...
private:
  ...
  const std::string &db_user = "user";                // Usuario MySQL
...
public:
  ...
  // Función para obtener tipo de Usuario 0 = Profesor 1 = Alumno 2 =
  // Administrador
  ...
  void insertarSolicitudesSicueProfesor(
      int solicitante_id, const std::string &nombre_solicitante,
      const std::string &universidad_origen,
      const std::vector<std::string> &universidades_destino,
      const std::string &departamento, const std::string &curso);
  int obtenerUserIdPorNombre(const std::string &nombre);
  std::vector<std::string>
  obtenerUniversidadesYaSolicitadas(const std::string &usuario);
  void
  modificarSolicitudSicueProfesor(const std::string &nombre_solicitante,
                                  const std::string &nuevoCurso,
                                  const std::string &nuevaUniversidadDestino);
  void actualizarPlazasOcupadas(const std::string &universidadOrigen,
  ...
  std::vector<std::string>
  obtenerUniversidadesConPlazasDisponiblesParaAlumno(const std::string &campo,
                                                     int anioCurso);
  ...
  void insertarSolicitudesSicueAlumno(
      int solicitante_id, const std::string &nombre_solicitante,
      const std::string &universidad_origen,
      const std::vector<std::string> &universidades_destino,
      const std::string &carrera, const std::string &curso);
  ...
  int obtenerAñoCursoAlumno(const std::string &usuario,
  ...
  std::vector<std::string>
  obtenerUniversidadesYaSolicitadasAlumno(const std::string &usuario);
  bool esPlazaDisponibleParaCurso(const std::string &universidad,
                                  const std::string &carrera, int añoCurso);
  ...
  void
  modificarSolicitudSicueAlumno(const std::string &nombre_solicitante,
                                const std::string &nuevoCurso,
                                const std::string &nuevaUniversidadDestino);
